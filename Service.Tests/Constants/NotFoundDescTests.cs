...
namespace Service.Tests.Constants
{
    public class NotFoundDescTests
    {
        ...
        public void NotFoundDescWithEntry()
        {
            ...
            var actualDictMsg = msg.NOTFOUND_DESC<Entry, Dictionary, int>(d => d.Index, entry.DictionaryIndex);
            var actualWordMsg = msg.NOTFOUND_DESC<Entry, Word, int>(w => w.ID, entry.WordID);
        ...
        public void NotFoundWihtWord()
        {
            ...
            var actualMsg = msg.NOTFOUND_DESC<Word, Language, String>(l => l.Name, word.SourceLanguageName);
