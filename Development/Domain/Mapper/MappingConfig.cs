...
namespace Domain.Mapper
{
    public class MappingConfig : AbstractMappingConfiguration
    {
        public MappingConfig()
        {
            ...
            RegisterMapping<CreateWordCommand, Word>((src, dest) =>
            {
            ...
            RegisterMapping<UpdateWordCommand, Word>((src, dest) =>
            {
                dest.Value = src.Value;
                foreach (var i in src.Properties)
                    dest.Properties.Add(Map<WordPropertyDto, WordProperty>(i));
            ...
            RegisterMapping<CreateLanguageCommand, Language>((src, dest) =>
            {
                dest.Name = src.Name;
                return dest;
            });
            ...
            RegisterMapping<CreateDictionaryCommand, Dictionary>((src, dest) =>
            {
            ...
            RegisterMapping<CreateFreeExpressionCommand, FreeExpression>((src, dest) =>
            {
            ...
            RegisterMapping<UpdateFreeExpressionCommand, FreeExpression>((src, dest) =>
            {
                return new()
                {
            ...
            RegisterMapping<CreateEntryCommand, Entry>((src, dest) =>
            {
                return new()
                {
                    DictionaryIndex = src.DictionaryIndex,
            ...
            RegisterMapping<UpdateEntryCommand, Entry>((src, dest) =>
            {
                return new()
                {
                    DictionaryIndex = src.DictionaryIndex,
            ...
            RegisterMapping<CreateMeaningCommand, Meaning>((src, dest) =>
            {
            ...
            RegisterMapping<UpdateMeaningCommand, Meaning>((src, dest) =>
            {
                dest.Notes = src.Notes;
                dest.Value = src.Value;
                foreach (var i in src.Examples)
